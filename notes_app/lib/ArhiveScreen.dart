...
class _ArchiveScreenState extends State<ArchiveScreen> {
  ...
  Future<void> getData() async {
    final data = await DbHelper.instance.getArchivedNotes();
    setState(() {
      notes = data;
    });
  }
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Your archive note will appear here",
            ...
            Padding(
              ...
              child: Text(
                "Archive notes to make your main list clean and organized . You can archive them any time",
                  ...
                  builder: (_) {
                    return Column(
                      children: [
                        ...
                        ListTile(
                          onTap: () async {
                            await DbHelper.instance.toggleTrash(
                              data.id!,
                              true,
                            );
                            Navigator.pop(context);
